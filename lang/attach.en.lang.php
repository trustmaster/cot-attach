...
$L['att_install'] = 'Install';
$L['att_install_confirm'] = 'Use it if you install for the first time only, or it will break existing attachments! Continue?';
$L['att_installed'] = 'Database installed';
$L['att_item'] = 'Item';
...
$L['att_err_upload'] = 'The file could not be uploaded or resulted into 0 size';
